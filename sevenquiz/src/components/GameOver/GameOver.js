...
const GameOver = () => {
    ...
    return (
        <div className="flex flex-col justify-self-center text-center m-2 my-10">
            ...
            <p className=" mt-10">Pontuacao: {quizState.score}</p>
            <p className=" mt-5">Voce acertou {quizState.score} de {quizState.questions.length}{" "} perguntas.</p>
            ...
            <button 
                className="mt-10 self-center rounded-3xl border-b-2 border-purple-600 hover:font-bold w-1/4 sm:h-10 text-xs sm:text-base"
